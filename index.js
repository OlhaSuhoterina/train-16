...
function compareArrays(arr1, arr2) {
  ...
  let newArr1 = arr1.sort(filterArr);
  let newArr2 = arr2.sort(filterArr);
  console.assert(
    JSON.stringify(newArr1) === JSON.stringify(newArr2),
    "масиви не однакові"
  );
...
function countVowelsAndConsonants(word) {
  ...
  for (const str of word) {
    ...
    if (string.indexOf(strNew) == -1) {
      count1 += 1;
      console.log(`Голосна:`, count1);
    } else {
      count2 += 1;
      console.log(`Приголосна:`, count2);
    }
  }
